...
tinymce.PluginManager.add('responsivefilemanager', function(editor) {
	...
	function openmanager() {
		...
		var akey="key";
		if (editor.getParam("filemanager_access_key")) {
		...
		var fldr="";
		if (editor.getParam("filemanager_subfolder")) {
			sort_by="&fldr="+editor.getParam("filemanager_subfolder");
		}

		var crossdomain="";
		if (editor.getParam("filemanager_crossdomain")) {
		...
		var fileUrl = editor.getParam("external_filemanager_path")+'dialog.php?type=4&descending='+descending+sort_by+fldr+crossdomain+'&lang='+editor.getParam("language")+'&akey='+akey;
