...
class LyceumController extends AdminController
{
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => HighSchool::find()->where(['type' => HighSchool::TYPE_LYCEUM])->orderBy(['active' => SORT_DESC, 'name' => SORT_ASC]),
    ...
    public function processHighSchoolData(HighSchool $highSchool)
    {
        if (\Yii::$app->request->isPost) {
            ...
            try {
                ...
                if (!$highSchool->load(Yii::$app->request->post())) \Yii::$app->session->addFlash('error', 'Form data not found');
                    ...
                    $highSchool->type = HighSchool::TYPE_LYCEUM;
        ...
        return $this->render('/high-school/update', [
    ...
    public function actionPage()
    {
        $prefix = 'highshchool_';
        $webpage = null;
        $moduleId = Module::getModuleIdByControllerAndAction('lyceum', 'index');
        ...
        return $this->render('/high-school/page', [
            'webpage' => $webpage,
    ...
    {
        if (($model = HighSchool::findOne($id)) !== null && $model->type == HighSchool::TYPE_LYCEUM) {
            return $model;
        } else {
