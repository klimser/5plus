        ...
        <div class="row">
            <div class="col-9 col-lg-10">
                <table class="small table table-sm">
                    ...
                    <tr><td>Группа</td><td><b><?= $contract->course->name; ?></b></td></tr>
            ...
            <div class="col-3 col-lg-2 text-right">
                ...
                <?php if ($contract->isNew()): ?>
                    <button type="button" onclick="Dashboard.showContractForm(this);" class="btn btn-success ml-2 mb-2" data-id="<?= $contract->id; ?>" data-pupil-name="<?= $contract->user->name; ?>"
                            data-group-name="<?= $contract->course->name; ?>" data-amount="<?= $contract->amount; ?>" data-create-date="<?= $contract->createDate->format('d.m.Y'); ?>"
                            data-group-date-start="<?= $contract->course->startDateObject->format('d.m.Y'); ?>" data-group-pupil="<?= $contract->activeGroupPupil ? 1 : 0; ?>"
