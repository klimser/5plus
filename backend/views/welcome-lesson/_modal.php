        ...
        <div class="modal-content">
            <form id="welcome-lesson-moving-form" onsubmit="WelcomeLesson.moveStudent(this); return false;">
                ...
                <div class="modal-body">
                    ...
                    <b>Группа</b>
                    <div class="course-proposal"></div>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input class="form-check-input" type="radio" name="welcome_lesson[course_proposal]" value="0" onchange="WelcomeLesson.courseChange(this);">
                            Другая
                        </label>
                    </div>
                    <select name="welcome_lesson[course_id]" class="form-control other-course" disabled></select>
                </div>
