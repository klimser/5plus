...
<div style="margin: 0.5cm;">
    ...
    <table class="bordered">
        <tr>
            ...
            <th>Количество акад.часов (1 акад.час = 40 мин.)</th>
        ...
        <tr>
            ...
            <td class="text-center"><?= round($contract->lessonsCount * ((float) $contract->group->lesson_duration / 40.0)); ?></td>
    ...
    <p style="color: gray; font-size: smaller;">
        * При запросе возврата внесенных за обучение остатков денежных средств по любой причине, не зависящей от ООО "Exclusive Education", последняя внесенная за обучение оплата пересчитывается по стоимости за 1 занятие с повышающим коэффициентом 1,25 к текущей стоимости 1 занятия при условии, что было проведено менее 12 занятий.<br>
        ** При увеличении или уменьшении Исполнителем стоимости занятий количество академических часов, указанных в данной спецификации, уменьшается или увеличивается согласно новой установленной стоимости занятий.
    </p>
    <br>
