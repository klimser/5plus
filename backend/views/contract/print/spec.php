...
<div style="margin: 0.5cm;">
    ...
    <p style="color: gray; font-size: smaller;">
        * При запросе возврата внесенных за обучение остатков денежных средств по любой причине, не зависящей от ООО "Exclusive Education", последняя внесенная за обучение оплата пересчитывается по стоимости за 1 занятие с повышающим коэффициентом 1,25 к текущей стоимости 1 занятия при условии, что было проведено менее 12 занятий.
    </p>
    <br>
