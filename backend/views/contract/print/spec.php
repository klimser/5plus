...
<div style="margin: 0.5cm;">
    ...
    <p></p>
    <p>Директор ООО «EXCLUSIVE EDUCATION», Климов Александр Сергеевич <img src="<?= require_once "sign.php"; ?>" style="width: 6cm;">
    </p>
    <p></p>
    <p></p>
    <p>
        <img src="<?= require_once "stamp.php"; ?>" style="width: 4cm;">
    </p>
</div>
