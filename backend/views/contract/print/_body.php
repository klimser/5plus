...
?>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                Нормативный срок освоения Программы составляет <span class="placeholder"><?= $contract->lessonsCount * 2; ?></span> академических часов (суммарно по всем предметам обучения). Один академический час равен 40 минут.
            </td>
        </tr>
        <tr>
            <td class="number">2.3.</td>
            <td>
                Нормативная продолжительность обучения составляет <span class="placeholder"><?= $contract->weeksCount; ?></span> недель.
            </td>
        </tr>
        <tr>
...
<div class="page">
    <table>
        <tr>
            ...
            <td>
                Оплата производится по безналичному расчету на расчетный счет Учреждения, как до даты заключения данного Договора, так и после даты заключения данного Договора (п.п.6.2, 6.3.), либо посредством пластиковых карт UZCARD, либо наличными, либо с помощью интернет-платежей.
            </td>
        </tr>
        <tr>
