                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            <button class="btn btn-default btn-lg w-100" type="button" id="payment-0" onclick="Contract.setPayment(0);">Без скидки<br><small><span class="price"></span> в месяц</small></button>
                        </div>
                        <div class="col-xs-12 col-sm-6">
                            <button class="btn btn-default btn-lg w-100" type="button" id="payment-1" onclick="Contract.setPayment(1);">Со скидкой<br><small><span class="price"></span> за 3 месяца</small></button>
                        </div>
                    </div>
