...
MESSAGE;
    ...
    const PAY_CHOOSE_GROUP = '🧑‍🤝‍🧑Выберите группу';
    const PAY_ONE_LESSON = 'Одно занятие';
    const PAY_ONE_MONTH = 'Один месяц';
    const PAY_CHOOSE_AMOUNT = '💰Выберите сумму для оплаты из представленных или введите свою сумму (не менее ' . self::PAY_MIN_AMOUNT . ').';
