                ...
                <div id="order_form_body" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-12 text-center">
                            <?php /*<button type="submit" onclick="return Payment.completePayment(this);" data-payment="<?= Contract::PAYMENT_TYPE_PAYBOX; ?>" class="btn freedompay_logo pay_button m-2">
                            ...
                            <a href="https://payment.apelsin.uz/merchant?serviceId=498605820" target="_blank" class="btn apelsin_logo pay_button m-2">
                                Оплатить через <span class="sr-only">Uzum</span> <i class="ml-2"></i>
                            </a>
