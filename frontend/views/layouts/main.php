                        ...
                        <div class="swiper-slide">
                            <div class="text">
                                ...
                                <div class="btns-group flex-column align-items-center align-items-md-start">
                                    ...
                                    <a href="https://beshplus.uz" class="btn btn-danger btn-ico btn-lg p-3 p-lg-4" target="_blank">Онлайн-школа BESHPLUS.UZ<span class="fas fa-globe ml-3"></span></a>
                                    <a href="https://fiveplus.uz" class="btn btn-primary btn-ico btn-lg p-3 p-lg-4" target="_blank">Видеокурсы FIVEPLUS.UZ<span class="fas fa-video ml-3"></span></a>
